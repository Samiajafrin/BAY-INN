...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            $sql = "SELECT *
                    FROM service
                    WHERE staff_name='$staff_name' and status='staff responded'";
            ...
            if($result -> num_rows > 0){
                ...
                while($rows = $result-> fetch_assoc()){
                    ...
                    <div class="review">
                        ...
                        <a href="processStaffServiceDone.php?serviceId=<?php echo $rows['id']?>" > <button id="back" >Done and Dusted</button> </a>  
                    </div>
