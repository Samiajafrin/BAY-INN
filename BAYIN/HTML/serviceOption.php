				...
				<div class="row">
					<div class="col-md-7 col-md-push-5">
						<div class="booking-cta">
							<h1>Service</h1>
							<p>Apply for a service and see your service status
							</p>
                            <div class="form-btn">
                                    ...
                                    <button class="submit-btn"> <a href="applyServicePage.php"> Apply for service </a></button>
                                    <button class="submit-btn"> <a href="serviceStatus.php"> service status </a></button>
